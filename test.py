...
def parse_args():
    ...
    parser.add_argument('--model_dir', default='/home/cs22-zhaoyz/zyz_medical2/my_AIA_df_un_kl/users-2/jianfeng/bayes/bayes_Kits19Seg_4_/',
...
def main():
    ...
    model_seg_path = os.path.join(model_dir, 'model_seg.pth')
